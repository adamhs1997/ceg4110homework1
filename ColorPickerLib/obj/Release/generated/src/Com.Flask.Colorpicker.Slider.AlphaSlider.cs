...
namespace Com.Flask.Colorpicker.Slider {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.flask.colorpicker.slider']/class[@name='AlphaSlider']"
	[global::Android.Runtime.Register ("com/flask/colorpicker/slider/AlphaSlider", DoNotGenerateAcw=true)]
	public partial class AlphaSlider : global::Com.Flask.Colorpicker.Slider.AbsCustomSlider {


		static IntPtr color_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.flask.colorpicker.slider']/class[@name='AlphaSlider']/field[@name='color']"
		[Register ("color")]
		public int Color {
			get {
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/flask/colorpicker/slider/AlphaSlider", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (AlphaSlider); }
		}

		protected AlphaSlider (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_content_Context_Landroid_util_AttributeSet_I;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.flask.colorpicker.slider']/class[@name='AlphaSlider']/constructor[@name='AlphaSlider' and count(parameter)=3 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.util.AttributeSet'] and parameter[3][@type='int']]"
		[Register (".ctor", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "")]
		public unsafe AlphaSlider (global::Android.Content.Context p0, global::Android.Util.IAttributeSet p1, int p2)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (AlphaSlider)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.flask.colorpicker.slider']/class[@name='AlphaSlider']/constructor[@name='AlphaSlider' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.util.AttributeSet']]"
		[Register (".ctor", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "")]
		public unsafe AlphaSlider (global::Android.Content.Context p0, global::Android.Util.IAttributeSet p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.flask.colorpicker.slider']/class[@name='AlphaSlider']/constructor[@name='AlphaSlider' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		[Register (".ctor", "(Landroid/content/Context;)V", "")]
		public unsafe AlphaSlider (global::Android.Content.Context p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.flask.colorpicker.slider']/class[@name='AlphaSlider']/method[@name='drawBar' and count(parameter)=1 and parameter[1][@type='android.graphics.Canvas']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.flask.colorpicker.slider']/class[@name='AlphaSlider']/method[@name='drawHandle' and count(parameter)=3 and parameter[1][@type='android.graphics.Canvas'] and parameter[2][@type='float'] and parameter[3][@type='float']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.flask.colorpicker.slider']/class[@name='AlphaSlider']/method[@name='onValueChanged' and count(parameter)=1 and parameter[1][@type='float']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.flask.colorpicker.slider']/class[@name='AlphaSlider']/method[@name='setColor' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.flask.colorpicker.slider']/class[@name='AlphaSlider']/method[@name='setColorPicker' and count(parameter)=1 and parameter[1][@type='com.flask.colorpicker.ColorPickerView']]"
