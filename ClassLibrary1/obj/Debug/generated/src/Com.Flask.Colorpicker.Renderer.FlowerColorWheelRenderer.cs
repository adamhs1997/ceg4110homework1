...
namespace Com.Flask.Colorpicker.Renderer {
	...
	public partial class FlowerColorWheelRenderer : global::Com.Flask.Colorpicker.Renderer.AbsColorWheelRenderer {
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/flask/colorpicker/renderer/FlowerColorWheelRenderer", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (FlowerColorWheelRenderer); }
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (FlowerColorWheelRenderer)) {
					SetHandle (
